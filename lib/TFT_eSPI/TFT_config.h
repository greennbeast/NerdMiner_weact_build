...
/* SDK config detected (ESP-IDF). Enable IDF-based configuration. */
#    ifdef CONFIG_DISABLE_WARNINGS
#        define DISABLE_ALL_LIBRARY_WARNINGS
#    endif

/* Override defaults for IDF builds */
#    define USER_SETUP_LOADED
#  endif
#else
/* Fallback: no sdkconfig available — keep Arduino/User_Setup selection active */
#endif
